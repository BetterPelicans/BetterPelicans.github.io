import{t as e}from"./shaderStore-DPDocHS6.js";var t=`morphTargetsVertexGlobalDeclaration`,n=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r={name:t,shader:n},i=`morphTargetsVertexDeclaration`,a=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o={name:i,shader:a},s=`morphTargetsVertexGlobal`,c=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l={name:s,shader:c},u=`morphTargetsVertex`,d=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
