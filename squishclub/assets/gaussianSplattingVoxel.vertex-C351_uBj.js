import{t as e}from"./shaderStore-DPDocHS6.js";import{t}from"./sceneUboDeclaration-DyYgyDG6.js";import{t as n}from"./meshUboDeclaration-CHgV5YdB.js";import{n as r,r as i,t as a}from"./gaussianSplatting-DFLZXrEY.js";var o=`gaussianSplattingVoxelVertexShader`,s=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;e.ShadersStore[o]||(e.ShadersStore[o]=s);var c=[i,t,n,r,a];for(let t of c)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var l={name:o,shader:s};export{l as gaussianSplattingVoxelVertexShader};