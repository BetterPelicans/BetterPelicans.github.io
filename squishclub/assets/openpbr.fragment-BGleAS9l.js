import{t as e}from"./shaderStore-DPDocHS6.js";import{n as t,t as ee}from"./clipPlaneFragment-DCYbwRyk.js";import{n as te,t as ne}from"./fogFragment-CpI9wonf.js";import{t as n}from"./sceneUboDeclaration-v5JrKZBD.js";import{t as r}from"./meshUboDeclaration-OnaQ6Lli.js";import{a as i,c as a,d as o,i as s,l as re,n as ie,o as ae,r as oe,s as se,t as ce,u as le}from"./oitFragment-Dq9CKMtY.js";import{t as ue}from"./mainUVVaryingDeclaration-BCliLxi2.js";import{t as de}from"./helperFunctions-C_lCG1NJ.js";import{n as fe,t as pe}from"./reflectionFunction-C6k98xx8.js";import{t as me}from"./logDepthDeclaration-CKhVQIMD.js";import{t as he}from"./logDepthFragment-KbjAHvnv.js";import{n as ge,t as _e}from"./pbrIBLFunctions-TRpMOP3v.js";import{t as ve}from"./pbrBRDFFunctions-CEQ29Aks.js";import{a as ye,i as be,n as xe,r as Se,t as Ce}from"./openpbrTransmissionLayerData-CGheYTmk.js";import{t as we}from"./harmonicsFunctions-Cj84DpQN.js";import{t as Te}from"./openpbrUboDeclaration-D83K0f0m.js";import{a as Ee,c as De,d as Oe,f as ke,i as Ae,l as je,n as Me,o as Ne,p as c,r as l,s as u,t as d,u as f}from"./pbrDebug-C0XxSl2h.js";var p=`openpbrFragmentSamplersDeclaration`,m=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h={name:p,shader:m},g=`openpbrNormalMapFragmentMainFunctions`,_=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=_);var v={name:g,shader:_},y=`openpbrNormalMapFragmentFunctions`,b=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var Pe={name:y,shader:b},x=`openpbrConductorReflectance`,S=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C={name:x,shader:S},w=`openpbrAmbientOcclusionFunctions`,T=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var Fe={name:w,shader:T},E=`openpbrVolumeFunctions`,D=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var Ie={name:E,shader:D},O=`openpbrNormalMapFragment`,k=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var Le={name:O,shader:k},A=`openpbrBlockNormalFinal`,j=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var Re={name:A,shader:j},M=`openpbrBaseLayerData`,N=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var ze={name:M,shader:N},P=`openpbrCoatLayerData`,F=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var Be={name:P,shader:F},I=`openpbrThinFilmLayerData`,L=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var Ve={name:I,shader:L},R=`openpbrFuzzLayerData`,z=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var He={name:R,shader:z},B=`openpbrAmbientOcclusionData`,V=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var Ue={name:B,shader:V},H=`openpbrBackgroundTransmission`,U=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var We={name:H,shader:U},W=`openpbrEnvironmentLighting`,G=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var Ge={name:W,shader:G},K=`openpbrDirectLightingInit`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var Ke={name:K,shader:q},J=`openpbrDirectLighting`,Y=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var qe={name:J,shader:Y},X=`openpbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var Je={name:X,shader:Z},Q=`openpbrPixelShader`,$=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var Ye=[o,le,n,r,Te,ue,c,re,fe,ge,h,i,t,me,te,oe,de,ke,Oe,f,s,ae,we,a,je,De,ve,u,se,Ne,Ee,Ae,_e,v,Pe,pe,ye,C,Fe,be,Se,Ie,ee,l,Le,Re,ze,Ce,xe,Be,Ve,He,Ue,ie,We,Ge,Ke,qe,he,ne,Me,Je,ce,d];for(let t of Ye)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Xe={name:Q,shader:$};export{Xe as openpbrPixelShaderWGSL};