import{t as e}from"./shaderStore-DPDocHS6.js";import"./sceneUboDeclaration-DyYgyDG6.js";import"./meshUboDeclaration-CHgV5YdB.js";var t=`gaussianSplattingVertexDeclaration`,n=`attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r={name:t,shader:n},i=`gaussianSplattingUboDeclaration`,a=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o={name:i,shader:a},s=`gaussianSplatting`,c=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
