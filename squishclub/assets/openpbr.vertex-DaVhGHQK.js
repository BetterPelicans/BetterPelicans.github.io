...
`;e.ShadersStore[q]||(e.ShadersStore[q]=J);var Y=[L,E,B,f,p,P,b,m,h,M,i,t,n,v,w,N,U,s,l,S,_,D,k,g,O,A,a,r,o,y,C,x,K,c,u,T,d,j];for(let t of Y)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var X={name:q,shader:J};export{X as openpbrVertexShader};