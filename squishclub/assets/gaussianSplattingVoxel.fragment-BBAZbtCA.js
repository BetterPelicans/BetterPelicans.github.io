...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r={name:t,shader:n},i=`gaussianSplattingVoxelPixelShader`,a=`var voxel_storage: texture_storage_3d<r8unorm,write>;var<storage,read_write> voxelOpacityBuffer: array<atomic<u32>>;
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=a);var o=[r];for(let t of o)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var s={name:i,shader:a};export{s as gaussianSplattingVoxelPixelShaderWGSL};