import{t as e}from"./shaderStore-DPDocHS6.js";import{n as t,t as ee}from"./clipPlaneFragment-DCYbwRyk.js";import{n,t as r}from"./fogFragment-CpI9wonf.js";import{t as te}from"./sceneUboDeclaration-v5JrKZBD.js";import{t as ne}from"./meshUboDeclaration-OnaQ6Lli.js";import{a as re,c as ie,d as ae,i as oe,l as se,n as ce,o as le,r as ue,s as de,t as fe,u as pe}from"./oitFragment-Dq9CKMtY.js";import{t as me}from"./mainUVVaryingDeclaration-BCliLxi2.js";import{t as he}from"./helperFunctions-C_lCG1NJ.js";import{n as ge,t as _e}from"./reflectionFunction-C6k98xx8.js";import{n as ve,r as ye,t as be}from"./bumpFragment-BeIuI7WE.js";import{t as xe}from"./logDepthDeclaration-CKhVQIMD.js";import{n as Se,t as i}from"./lightFragment-DknYOzHo.js";import{t as a}from"./logDepthFragment-KbjAHvnv.js";import{n as o,t as Ce}from"./pbrIBLFunctions-TRpMOP3v.js";import{t as we}from"./pbrBRDFFunctions-CEQ29Aks.js";import{t as Te}from"./harmonicsFunctions-Cj84DpQN.js";import{a as Ee,c as De,d as Oe,f as ke,i as Ae,l as je,n as Me,o as Ne,p as Pe,r as Fe,s as Ie,t as Le,u as Re}from"./pbrDebug-C0XxSl2h.js";import{t as ze}from"./pbrUboDeclaration-DzvtusoP.js";var s=`samplerFragmentAlternateDeclaration`,c=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var l={name:s,shader:c},u=`pbrFragmentSamplersDeclaration`,d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var f={name:u,shader:d},p=`pbrBlockAlbedoOpacity`,m=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var Be={name:p,shader:m},h=`pbrBlockReflectivity`,g=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var Ve={name:h,shader:g},_=`pbrBlockAmbientOcclusion`,v=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var He={name:_,shader:v},y=`pbrBlockAlphaFresnel`,b=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var Ue={name:y,shader:b},x=`pbrBlockAnisotropic`,S=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var We={name:x,shader:S},C=`pbrBlockReflection`,w=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var Ge={name:C,shader:w},T=`pbrBlockSheen`,E=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var Ke={name:T,shader:E},D=`pbrBlockClearcoat`,O=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k={name:D,shader:O},A=`pbrBlockIridescence`,j=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var qe={name:A,shader:j},M=`pbrBlockSubSurface`,N=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var Je={name:M,shader:N},P=`pbrBlockNormalFinal`,F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var Ye={name:P,shader:F},I=`pbrBlockLightmapInit`,L=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var Xe={name:I,shader:L},R=`pbrBlockGeometryInfo`,z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var Ze={name:R,shader:z},B=`pbrBlockReflectance`,V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var Qe={name:B,shader:V},H=`pbrBlockDirectLighting`,U=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var $e={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var et={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var tt={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var nt={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var rt={name:X,shader:Z},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var it=[ae,pe,te,ne,ze,me,Pe,se,ge,l,o,f,re,t,xe,n,ue,he,ke,Oe,Re,oe,le,Te,ie,je,De,we,Ie,de,Ne,Ee,Ae,Ce,ye,ve,_e,Se,Be,Ve,He,Ue,We,Ge,Ke,k,qe,Je,ee,Fe,be,Ye,ce,Xe,Ze,Qe,$e,i,et,tt,nt,a,r,Me,rt,fe,Le];for(let t of it)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var at={name:Q,shader:$};export{at as pbrPixelShaderWGSL};