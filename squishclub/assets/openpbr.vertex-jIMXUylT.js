...
}`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U=[f,p,P,E,m,h,M,i,t,n,b,v,N,L,s,l,w,D,k,g,S,_,O,A,a,r,o,y,C,x,B,c,u,T,d,j];for(let t of U)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var W={name:V,shader:H};export{W as openpbrVertexShaderWGSL};